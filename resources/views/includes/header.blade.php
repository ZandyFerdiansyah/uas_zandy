...
<head>
	...
	<!-- CSS Files -->
	<link rel="stylesheet" href="{{asset('backassets/css/bootstrap.min.css')}}">
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="white">
				...
				<!-- <a href="\" class="logo">
					<img src="" alt="" class="navbar-brand" width="150" height="60"> 
				</a> -->
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="{{asset('back/assets/img/jm_denis.jpg')" alt="Img Profile">
												</div>
